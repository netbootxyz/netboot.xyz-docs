...
export default function Downloads() {
  const popularDownloads = [
    {
      ...
      description:
        'Universal ISO image for CD/DVD, Virtual CDs, DRAC/iLO, VMware, VirtualBox. Works with both Legacy BIOS and UEFI systems.',
    ...
    },
    {
      ...
      description:
        'USB bootable image for creating USB keys. Supports both Legacy BIOS and UEFI systems.',
    ...
    },
    {
      ...
      description:
        'Combined x86_64 and ARM64 ISO image. Perfect for mixed environments with different architectures.',
    ...
    },
    {
      ...
      description:
        'Combined x86_64 and ARM64 USB image for creating universal USB keys.',
  ...
  const legacyBootloaders = [
    {
      ...
      description:
        'Linux kernel format for booting from GRUB or EXTLINUX bootloaders.',
    ...
    },
    {
      ...
      description:
        'Virtual floppy disk image for older systems, DRAC/iLO, VMware, VirtualBox.',
    ...
    },
    {
      ...
      description:
        'Padded virtual floppy disk for systems that require specific disk geometry.',
    ...
    },
    {
      ...
      description:
        'DHCP network boot image with built-in iPXE NIC drivers for PXE booting.',
    ...
    },
    {
      ...
      description:
        'DHCP network boot image for systems with problematic network cards.',
  ...
  const uefiBootloaders = [
    ...
    },
    {
      ...
      description:
        'UEFI with Simple Network Protocol, attempts to boot from all network devices.',
    ...
    },
    {
      ...
      description:
        'UEFI with Simple Network Protocol, only boots from the device it was chained from.',
  ...
  const arm64Bootloaders = [
    ...
    },
    {
      ...
      description:
        'ARM64 UEFI with Simple Network Protocol, attempts to boot from all network devices.',
    ...
    },
    {
      ...
      description:
        'ARM64 UEFI with Simple Network Protocol, only boots from device chained from.',
        ...
        <div className="container">
          <header className={styles.pageHeader}>
            ...
            <p className={styles.pageDescription}>
              ...
              All downloads automatically load into{' '}
              <strong>boot.netboot.xyz</strong>.
            </p>
            <div className={styles.infoBox}>
              <p>
                Looking for release versions? Download them from{' '}
                <a
                  href="https://github.com/netbootxyz/netboot.xyz/releases"
                  target="_blank"
          ...
          <div className={styles.checksumsSection}>
            ...
            <p>
              ...
              <a
                href="https://boot.netboot.xyz/ipxe/netboot.xyz-sha256-checksums.txt"
                target="_blank"
                rel="noopener noreferrer"
              >
                here
              ...
              <a
                href="https://github.com/netbootxyz/netboot.xyz/tree/master/roles/netbootxyz/templates/disks"
                target="_blank"
                rel="noopener noreferrer"
              >
                on GitHub
